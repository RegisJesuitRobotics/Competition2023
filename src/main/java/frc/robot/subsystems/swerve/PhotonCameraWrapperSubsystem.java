...
public class PhotonCameraWrapperSubsystem extends SubsystemBase {
...

    {
        try {
            ...
            camList.add(
                    new Pair<PhotonCamera, Transform3d>(frontCamera, Constants.VisionConstants.FRONT_CAMERA_LOCATION));
            camList.add(
                    new Pair<PhotonCamera, Transform3d>(backCamera, Constants.VisionConstants.BACK_CAMERA_LOCATION));

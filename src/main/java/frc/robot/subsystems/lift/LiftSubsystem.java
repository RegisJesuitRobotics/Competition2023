...
public class LiftSubsystem extends SubsystemBase {
    private final CANSparkMax topLeftMotor = new CANSparkMax(LiftConstants.TOP_LEFT_MOTOR_PORT, MotorType.kBrushless);

    private final CANSparkMax bottomLeftMotor =
            new CANSparkMax(LiftConstants.BOTTOM_LEFT_MOTOR_PORT, MotorType.kBrushless);

    private final CANSparkMax topRightMotor = new CANSparkMax(LiftConstants.TOP_RIGHT_MOTOR_PORT, MotorType.kBrushless);
